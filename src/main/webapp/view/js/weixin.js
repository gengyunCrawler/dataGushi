...
function bindWx(data,pageNo) {
    ...
    '<th id="origin" original-title="带原创标识的文章数" >原创数<span class="questionmark">[?]</span></th>'+
        ...
        '<th id="quaVector"  original-title="平均阅读数、平均点赞数和点赞率的加权">活跃指数<span  class="questionmark">[?]</span></th>'+
        '<th id="influence"  original-title="总阅读数和总点赞数的加权">传播指数<span  class="questionmark">[?]</span></th>'+
        '<th id="influence"  original-title="总阅读数和总点赞数的加权">质量指数<span  class="questionmark">[?]</span></th>'+
